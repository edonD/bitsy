...
export default defineSchema({
  ...
  training_runs: defineTable({
    ...
    rmse: v.number(),
    mae: v.number(),
    in_sample_r2: v.optional(v.number()),
    in_sample_rmse: v.optional(v.number()),
    in_sample_mae: v.optional(v.number()),
    evaluation_r2: v.optional(v.number()),
    evaluation_rmse: v.optional(v.number()),
    evaluation_mae: v.optional(v.number()),
    training_mode: v.optional(v.string()),
    validation_mode: v.optional(v.string()),
    contribution_method: v.optional(v.string()),
