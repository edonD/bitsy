        ...
        <section className="mt-14 border-t border-[color:var(--line)] pt-10">
          ...
          <div className="mt-4 space-y-3">
            {[
              ...
              { step: "5", title: "Predict", desc: "User toggles a GEO strategy or analyzes draft content. Surrogate predicts aggregate mention rate in ~1ms. Per-model lift remains gated until enough history accumulates. Planned: conformal intervals." },
